...
import { faUserPlus, faRightLong } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className={styles.container}>
        ...
        <div className={styles.saveGroupCode}>
          ...
          <p>
            ...
            <FontAwesomeIcon icon={faUserPlus} />) in the top section of the
            main application to avoid losing access to your group on this
            device.
          </p>
        </div>
      </div>
